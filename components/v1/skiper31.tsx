...
const Skiper31 = () => {
 ...
 ref={targetRef}
      ...
      <div
        ref={targetRef2}
        className="relative -mt-[35vh] sm:-mt-[45vh] box-border flex h-[90vh] sm:h-[100vh] flex-col items-center justify-center gap-[2vw] overflow-hidden bg-[#0f172a] p-[2vw]"
      >
      ...
      <div
        ref={targetRef3}
        className="relative -mt-[30vh] sm:-mt-[40vh] box-border flex h-[90vh] sm:h-[100vh] flex-col items-center justify-center gap-[2vw] overflow-hidden bg-[#0f172a] p-[2vw]"
      >
